  				...
  				<!-- 	<div class="row">
  					...
  					<div class="row">
						...
						<div class="col-sm-2">
  						...
  						<div class="col-sm-2">
    						<label class="col-sm-12 col-form-label">Agreement :</label>
    ...
    $("#btnconfirm").click(function(){
      // alert("work");
       ...
       var rqdet = $("#detail").val();
        ...
        url : "rental_quotation_sdata.php",
        method : "GET",
        data : {rqdate:rqdate, rqto:rqto, rqsub:rqsub, rqdet:rqdet},
        success : function(response){
          alert("rental Quotation sdata collected");
        }
...
<script type="text/javascript">
  $(document).ready(function(){
    $("#btnconfirm").click(function(){
      ...
      $.ajax({
        url:"rental_quotation_adata.php",
        method:"GET",
        data:{rqto:rqto, ar1:ar1, ar2:ar2, ar3:ar3, ar4:ar4, ar5:ar5},
        success:function(response){
          alert("rental quotation a data collected ");
        }
