...
$data=$obj->displayid("tblcustomer","fname",$id);
foreach ($data as $get) {
              ...
              <form class="form-horizontal">
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" value="<?php echo $get['fname'];?>" id="fname" placeholder="" readonly>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="ptype" class="col-sm-2 col-form-label">Last Name</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" value="<?php echo $get['lname'];?>" id="lname" placeholder="">
                    </div>
                  </div>
                   ...
                   <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <select class="form-control" value="<?php echo $get['gender'];?>" id="gender">
                   ...
                   <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" value="<?php echo $get['company'];?>" id="company" placeholder="">
                    </div>
                  </div>
                   ...
                   <div class="form-group row">
                    ...
                    <div class="col-sm-10 input-group-prepend">
                      ...
                      <input type="text" class="form-control" value="<?php echo $get['phone'];?>" id="phone" placeholder="">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                     <label for="pcode" class="col-sm-2 col-form-label">Email</label>
                      <div class="col-sm-10 input-group-prepend">
                        ...
                        <input type="mail" class="form-control" value="<?php echo $get['email'];?>" id="mail" placeholder="">
                      </div>
                  </div>
                   ...
                   <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" value="<?php echo $get['uname'];?>" id="uname" placeholder="">
                    </div>
                  </div>
                   ...
                   <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="password" class="form-control" value="<?php echo $get['pwd'];?>" id="pwd" placeholder="">
                    </div>
                  </div>
                   ...
                   <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <select class="form-control" value="<?php echo $get['cstatus'];?>" id="status">
                          <option>-Select-</option>
                          <option>1</option>
                          <option>2</option>
                      </select>
                   ...
                   <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" value="<?php echo $get['cgroup']; }?>" id="group" placeholder="">
                    </div>
                  </div>
   ...
   $(document).ready(function(){
      $("#btnconfirm").click(function(){
        ...
        $.ajax({
          ...
          url : "customer_entrysdata_update.php",
          method : "GET",
