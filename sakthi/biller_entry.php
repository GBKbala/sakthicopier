        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Biller Entry</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">BILLER ENTRY</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal">
                <div class="card-body">
                  ...
                  <div class="form-group row">
                   ...
                   <div class="form-group row">
                    ...
                    <div class="col-sm-10 input-group-prepend">
                      ...
                      <input type="text" class="form-control" id="phno" placeholder="">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                   ...
                   <div class="form-group row">
                    <label for="ptype" class="col-sm-2 col-form-label">Biller Type </label>
                    <div class="col-sm-10">
